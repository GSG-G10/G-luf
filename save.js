...

{
    startPlay ===  false ? null : theGame()
        ...
        <div className="game" >
            ...
            <div className="box block" style={{animationPlayState: isActive , '--i': 11}}>
                <img src={fireSVg} alt="fire down" />
            </div> 


            <div className="box block" style={{animationPlayState: isActive , '--i': 12}}>
                <img src={fireSVg} alt="fire down" />
            </div> 


            <div className="box block" style={{animationPlayState: isActive , '--i': 13}}>
                <img src={fireSVg} alt="fire down" />
            </div> 


            <div className="box block" style={{animationPlayState: isActive , '--i': 14}}>
                <img src={fireSVg} alt="fire down" />
            </div> 
